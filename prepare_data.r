path <- '/Users/manuel/SeaDrive/Shared with groups/ManuelProject0/Confocal-scRNA/paper/FinalDatasets/ALLGENES_ns_2_nt_5_alpha_0.1_epsilon_0.05_top_sccells_50_top_hvg_100.txt'
dge <- read.csv(path, row.names = 1)
dge <- as.data.frame(t(dge))

path <- "/Users/manuel/SeaDrive/Shared with groups/ManuelProject0/Confocal-scRNA/paper/FinalDatasets/PEP_spearman_enrDGEjose_allgenes_final.csv"
...
write.csv(x = dge_top_1000_genes, file = path)
